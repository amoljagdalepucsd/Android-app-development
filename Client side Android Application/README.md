Addpost app will insert posts(html files with images) by reading a text file (see sample_input)into the database of showpost app which will then notify the user.
